...
class MyProfileController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('approver/my_profile', ['user' => $user]);
    }
    ...
    public function updateUserDetail()
    {
        ...
        if (
            ...
            return redirect()->to('/approver/my_profile')->with('info', 'No data changes were made. Make sure you entered the new data before submit.');
        }
        ...
        return redirect()->to('/approver/my_profile')->with('success', 'Data successfully updated.');
    }
}
